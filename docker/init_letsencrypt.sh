...
domains=(pocdefensoria.lappis.rocks)
rsa_key_size=4096
data_path="../certbot"
email="arthurrtl@gmail.com" # Adding a valid address is strongly recommended
...
#docker-compose -f $composefile up -d rocketchat
